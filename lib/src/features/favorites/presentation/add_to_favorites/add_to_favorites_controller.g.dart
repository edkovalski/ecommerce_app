...
part of 'add_to_favorites_controller.dart';
...
String $AddToFavoritesControllerHash() =>
    r'9561d9e66460bf7ea99dce03b7a5900b38a7f930';

/// See also [AddToFavoritesController].
final addToFavoritesControllerProvider =
    AutoDisposeAsyncNotifierProvider<AddToFavoritesController, void>(
  AddToFavoritesController.new,
  name: r'addToFavoritesControllerProvider',
  debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
      ? null
      : $AddToFavoritesControllerHash,
);
typedef AddToFavoritesControllerRef = AutoDisposeAsyncNotifierProviderRef<void>;

abstract class _$AddToFavoritesController
